...
const Home: React.FC = () => {
    const { services, courses } = useData();
    ...
    return (
        <>
            ...
            <section className="py-20 bg-primary-50 dark:bg-gray-800">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl md:text-4xl font-serif font-bold text-gray-900 dark:text-white mb-4">Academy & Courses</h2>
                        <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
                            Learn the art of makeup from the experts. From self-grooming to professional certification.
                        </p>
                    </div>
